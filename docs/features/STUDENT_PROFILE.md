...
## 1. Onboarding Wizard
When a new student first logs in, they are directed to a **7-Step Onboarding Wizard** (`app/(dashboard)/onboarding/`):

1. **Personal Information**: Basic identity and parent/guardian contact details.
2. **Academic Profile**: Curriculum type (IB, CBSE, etc.) and grading system.
3. **Transcripts**: Course-by-course breakdown of grades and honors levels.
4. **Activities**: Extracurricular involvement with time commitment tracking.
5. **Achievements**: Awards, honors, and recognition.
6. **Projects & Research**: Independent work, internships, or summer programs.
7. **Review**: Summary of all data and final submission.
...
- **Personal/Academic**: 15% each.
- **Transcripts**: 25% (Target: 5+ courses).
- **Test Scores**: 10%.

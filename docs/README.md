...
Welcome to the Waypoint College Counseling Platform documentation. This portal provides a comprehensive guide for developers, architects, and product managers.

## 🚀 Quick Start
If you are a developer looking to get the project running locally, head straight to the [Development Guide](DEVELOPMENT_GUIDE.md).

## 🏗️ Core Documentation
| Document | Description |
|---|---|
| [STUDENT_LIFECYCLE.md](STUDENT_LIFECYCLE.md) | **Start Here**: The 3-phase student journey and lifecycle transitions. |
| [ARCHITECTURE.md](ARCHITECTURE.md) | High-level system design, auth flow, roles, and tech stack. |
| [DATA_MODEL.md](DATA_MODEL.md) | Database schema reference (Prisma) and naming conventions. |
| [UI_STYLE_GUIDE.md](UI_STYLE_GUIDE.md) | Design tokens, branding, and reusable component library. |
| [DEVELOPMENT_GUIDE.md](DEVELOPMENT_GUIDE.md) | Local setup, environment variables, and deployment instructions. |
